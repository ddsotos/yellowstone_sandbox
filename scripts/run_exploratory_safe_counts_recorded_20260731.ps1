...
$name = 'v2_exploratory_safe_counts_recorded_20260731'
...
$maxGames = if ($env:EXPLORATORY_MAX_GAMES) { [int]$env:EXPLORATORY_MAX_GAMES } else { 20000 }
...
$arguments = @(
  '-m', 'yellowstone.exploratory_collection',
  '--checkpoint', $checkpoint,
  '--seed', '20260730',
  '--game-id-offset', '1300000',
  '--output', $output,
  '--stop-file', $stopFile,
