...
$env:PYTHONPATH = 'src'
$name = 'v2_variant_board5_hand6_oneoff_tiered_heuristic4_20260802_part2'
$statusPath = "results\collections\$name.status.json"
$stopFile = "results\collections\$name.stop"
$output = "data\$name"
$maxGames = if ($env:VARIANT_HEURISTIC4_PART2_MAX_GAMES) { [int]$env:VARIANT_HEURISTIC4_PART2_MAX_GAMES } else { 200000 }
